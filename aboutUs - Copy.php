...
<head>
    ...
    <style>
       ...
       .head-text h1{
        ...
        .mission-vission .mission, .vission, h4, p{
            color: #fff;
            text-align: center;
        }
        .our-members{
    ...
    <div class="our-team">
       <div class="user-card">
            <div class="user-content">
                <div class="imgBx">
                    <img src="C:\xampp\htdocs\IMAGE-SLIDER\authors\user-1.jpg" alt="">
                </div>
                <div class="contentBx">
                ...
                <div class="sci">
                    <a href=""><i class="fa-brands fa-2x me-3 fa-facebook"></i></a>
                    <a href=""><i class="fa-brands fa-2x me-3 fa-square-instagram"></i></a>
                    <a href=""><i class="fa-brands fa-2x me-3 fa-twitter"></i></a>
                </div>
            </div>
        </div>
        <div class="user-card">
