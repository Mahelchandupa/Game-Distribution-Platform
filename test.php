...
<div class="our-mission-vission mt-5 col-md-9 mx-auto mb-5">
    <div class="m-v-image">
...
<hr style="color: red;">
<!--
<div class="mt-5" style="  background-image:url(images/review-bg-2.jpg);
          background-position: center;
          background-size: cover;
          width: 100%;
          min-height: 65vh;">
<h2 style="color: #fff; text-align: center; font-family: 'Poppins', sans-serif; padding: 20px 0;">Our Team</h2>
  <div class="our" style="display: flex;
            justify-content: center;
            align-items: center;
            flex-wrap: wrap;">
  <div class="use-card" style="      width: 260px;
            height: 300px;
            padding: 30px 30px;
            margin: 20px;
            background: #f2f3f7;
            ...
            flex-direction: column;">
                <div class="imgBx" style="   width: 120px;
            height: 120px;
            border-radius: 50%;
            position: relative;
            overflow: hidden;
            margin-bottom: 20px;">
                    <img src="authors/2.jpg" alt="" style="   top: 0;
            left: 0;
            position: absolute;
            width: 100%;
            height: 100%;
            object-fit: cover;">
                ...
                <div class="contentBx">
                    <h4  style="color: #36187d;
            font-size: .9rem;
            font-weight: bold;
            text-align: center;
            letter-spacing: 1px;
            font-family: 'Poppins', sans-serif;">Bhanuka Senevirathna</h4>
                    <h5 style="  color: #6c758f;
            font-size: .8rem;
            font-weight: bold;
            text-align: center;
            letter-spacing: 1px;
            font-family: 'Poppins', sans-serif;">Director General</h5>
                </div>
                <div class="sci" style="margin-top: 10px;">
                    <a href="" style="  text-decoration: none;
            color: #6c758f;
            font-size: 25px;
            margin: 10px;
            transition: color 0.4s;"><i class="fa-brands fa-facebook"></i></a>
                    <a href="" style="  text-decoration: none;
            color: #6c758f;
            font-size: 25px;
            margin: 10px;
            transition: color 0.4s;"><i class="fa-brands fa-square-instagram"></i></a>
                    <a href="" style="  text-decoration: none;
            color: #6c758f;
            font-size: 25px;
            margin: 10px;
            transition: color 0.4s;"><i class="fa-brands fa-twitter"></i></a>
                </div>
            </div>
        </div>
  ...
  <div class="use-card" style="      width: 260px;
            ...
            overflow: hidden;
            margin-bottom: 20px;">
                    <img src="authors/user-1.jpg" alt="" style="   top: 0;
            left: 0;
            position: absolute;
            width: 100%;
            height: 100%;
            ...
            text-align: center;
            letter-spacing: 1px;
            font-family: 'Poppins', sans-serif;">Mahel Chandupa</h4>
                    <h5 style="  color: #6c758f;
            font-size: .8rem;
            font-weight: bold;
            text-align: center;
            letter-spacing: 1px;
            font-family: 'Poppins', sans-serif;">Developer</h5>
                </div>
                <div class="sci" style="margin-top: 10px;">
                    <a href="" style="  text-decoration: none;
            color: #6c758f;
  ...
  <div class="use-card" style="      width: 260px;
            ...
            overflow: hidden;
            margin-bottom: 20px;">
                    <img src="authors/7.jpg" alt="" style="   top: 0;
            left: 0;
            position: absolute;
            width: 100%;
            height: 100%;
            ...
            text-align: center;
            letter-spacing: 1px;
            font-family: 'Poppins', sans-serif;">Nimeshika Gamage</h4>
                    <h5 style="  color: #6c758f;
            font-size: .8rem;
            font-weight: bold;
            text-align: center;
            letter-spacing: 1px;
            font-family: 'Poppins', sans-serif;">Ui Designer</h5>
                </div>
                <div class="sci" style="margin-top: 10px;">
                    <a href="" style="  text-decoration: none;
            color: #6c758f;
